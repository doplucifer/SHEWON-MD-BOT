...
limitawal = '100'
botname = 'QUEEN-THARU-MD-BOT'
wm = 'QUEEN-THARU-MD-BOT'
global.reactmoji = '🎭'
...
//BY QUEEN-THARU-MD-BOT
	// auto set bio
	if (db.data.settings[botNumber].autobio) {
	    let setting = global.db.data.settings[botNumber]
	    if (new Date() * 1 - setting.status > 1000) {
		let uptime = await runtime(process.uptime())
		await ZimBotInc.setStatus(`QUEEN-THARU-MD|BOT ONLINE: ${runtime(uptime)}`)
...
{      
 ...
 break
      case 'LUCIFER': {
kingbotcmd = `[🧚QUEEN-THARU-MD-BOT🧚‍♀️] 
...
let drips = [
  ...
  break
          ...
          urlButton: {
                  displayText: 'GITHUB',
                  url: 'https://github.com/doplucifer/QUEEN-THARU-MD-BOT'
          }
                            }]
                      let txt = `「 *QUEEN-THARU-MD-BOT BROADCAST* 」\n\n${text}`
...
if (isBan) throw mess.ban
        ...
        if (!text) return reply(`Example : ${prefix + command} QUEEN-THARU-MD-BOT`)
...
╰━━━━━━━━━━━━━━━━━━╯`,
      ...
      const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://youtube.com/c/slcartooninstudio` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/doplucifer/QUEEN-THARU-MD-BOT` } },
   {					
					quickReplyButton: {
						displayText: 'SPEED',
						id: 'ping'
